...
class LogisticRegression {
	constructor(features, labels, options) {
		...
		this.options = options = Object.assign({ learningRate: 0.1, iterations: 1000, decisionBoundary: 0.5 }, options)
	...
	test(testFeatures, testLabels) {
		...
		const incorrect = predictions.notEqual(testLabels).sub(testLabels).sum().get()
